...
@Component({
  selector: 'app-electricaldevices',
  templateUrl: './electricaldevices.component.html',
  styleUrls: ['./electricaldevices.component.css']
})


export class ElectricaldevicesComponent  implements OnInit {
